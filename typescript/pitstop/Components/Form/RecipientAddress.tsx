...
export type RecipientAddressProps = OmitStrict<InputProps, "id" | "name"> & {
  id: string
  name: string
  label?: React.ReactNode
  hint?: React.ReactNode
}
export function RecipientAddress({ id, name, label, hint, ...rest }: Readonly<RecipientAddressProps>) {
