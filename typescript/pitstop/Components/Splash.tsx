...
export function Splash() {
  ...
  return (
    <div className="flex w-full flex-col gap-y-12 py-8">
      <div className="grid w-full grid-cols-3 gap-x-8" style={{ marginTop: "40px" }}>
        <div className="col-span-2">
          <div className="flex flex-col gap-y-4" style={{ marginLeft: "60px" }}>
            <h3 className="font-sans text-[48px] leading-tight tracking-wide whitespace-nowrap uppercase">
              Your crosschain filling station
            </h3>
            <p className="text-[24px] whitespace-break-spaces text-black/90" style={{ lineHeight: "1.2" }}>
            ...
            <div className="flex items-center gap-x-6 text-white" style={{ marginTop: "100px", marginLeft: "70px" }}>
              ...
              <div className="flex items-center">
                ...
                <Image
                  ...
                  height={90}
                  alt="Polygon"
                  className="ml-6 size-[90px] object-cover"
                />
                <Image
                  ...
                  height={90}
                  alt="Ethereum"
                  className="ml-2 size-[90px] object-cover"
                />
              </div>
            </div>
          </div>
      ...
      <div
        className="flex w-full items-center justify-center gap-x-4 py-4 text-center text-black uppercase"
        style={{ marginBottom: "-50px" }}
      >
        <GearIcon size={10} className="size-10" weight="fill" />
        <h5 className="font-mono text-[40px] font-bold tracking-normal text-black uppercase">
          Full service in 3 steps
        </h5>
        <GearIcon size={10} className="size-10" weight="fill" />
      </div>
      <div className="mx-auto grid grid-cols-3 gap-x-[22px]" style={{ maxWidth: "1340px" }}>
        <div className="flex flex-col items-center justify-start gap-y-4 p-6">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-y-2">
            <p className="w-full text-center font-mono text-[24px] font-bold tracking-wide uppercase">1. Pull in</p>
            <p className="w-full text-center font-mono text-[18px] text-black/80" style={{ lineHeight: "0.91" }}>
              Connect your wallet.
            </p>
            <p className="w-full text-center font-mono text-[18px] text-black/80" style={{ lineHeight: "0.91" }}>
              No paperwork needed.
        ...
        <div className="flex flex-col items-center justify-start gap-y-4 p-6">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-y-2">
            <p className="w-full text-center font-mono text-[24px] font-bold tracking-wide uppercase">
              2. Pick your chain
            </p>
            <p className="w-full text-center font-mono text-[18px] text-black/80" style={{ lineHeight: "0.91" }}>
              Choose ETH or Base.
      ...
      <div
        className="mx-auto"
        style={{ maxWidth: "1340px", marginTop: "-60px", marginLeft: "calc(50% - 670px + 216px)" }}
      >
      ...
      >
        ...
        <div className="relative flex flex-col items-center justify-center" style={{ zIndex: 1 }}>
          <h2 className="mb-8 font-mono text-[42px] font-bold text-white uppercase">Why drivers choose Pit Stop:</h2>

          <div
            className="grid w-full gap-x-12 gap-y-12 px-16"
            style={{ gridTemplateColumns: "1fr 1fr", maxWidth: "1000px" }}
          >
            <div className="flex flex-col items-center text-center">
              <h3 className="mb-3 font-mono text-[24px] font-bold text-white uppercase underline">NO BRIDGE NEEDED</h3>
            ...
            <div className="flex flex-col items-center text-center">
              <h3 className="mb-3 font-mono text-[24px] font-bold text-white uppercase underline">INSTANT DELIVERY</h3>
              <p className="font-mono text-[18px] leading-tight text-white">
                Gas in your tank
                <br />
                in under a minute.
            ...
            <div className="flex flex-col items-center text-center">
              <h3 className="mb-3 font-mono text-[24px] font-bold text-white uppercase underline">PAY WITH USDC</h3>
              <p className="font-mono text-[18px] leading-tight text-white">
                Use USDC on Polygon,
                <br />
                We&apos;ll convert.
            ...
            <div className="flex flex-col items-center text-center">
              <h3 className="mb-3 font-mono text-[24px] font-bold text-white uppercase underline">TRACK YOUR FILLS</h3>
              <p className="font-mono text-[18px] leading-tight text-white">
                Service history and
                <br />
